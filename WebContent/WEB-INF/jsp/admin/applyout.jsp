							...
							<tbody>
								...
								<c:forEach items="${applyout}" var="applyout">
									...
									<tr
										...
										<a class="link-update"
											href="<%=path%>/applyout/agreeapplyout.action?id=${applyout.id }"
											onclick="return window.confirm('确定要同意退租吗？')">同意</a>
											&nbsp;&nbsp; 
											
											<a class="link-del"
											 href="<%=path%>/applyout/refuseapplyout.action?id=${applyout.id }"
											onclick="return window.confirm('确定要拒绝吗？')">拒绝</a>
											</c:when >
											<c:otherwise>
												 <a class="link-del"
											 href="<%=path%>/applyout/deleteapplyout.action?id=${applyout.id}"
