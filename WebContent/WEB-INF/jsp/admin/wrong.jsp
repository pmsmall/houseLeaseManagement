...
<html>
	...
	<body>
		<div>
			...
			<form id="houseForm" name="houseForm" action="/wrong/wronglist.action" method=post>
				<div class="result-title">
						...
						<tbody>
							...
							<c:forEach items="${wrong}" var="wrong">
								...
								<tr class="result_tab_body">
									...
									<td>${wrong.status}</td>
									<td>
										<a class="link-update" href="/houseLeaseManagement/wrong/gotosolve.action?id=${wrong.id }" onclick="return window.confirm('确定你已处理此报障？')">已处理</a>
										&nbsp;&nbsp;
