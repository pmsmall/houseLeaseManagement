...
<body>
	...
	<div class="result-content">
		<div class="sidebar-title">
			<form action="/schedule/updateschedule.action" method="post"
				...
				<table class="insert-tab" width="100%">
					<tbody>
						...
						<td><input class="common-text required"
							value="${schedule.date}" id="date" name="date" size="50"
							type="text" readonly></td>
						</tr>
						<tr>
							<th><i class="require-red">*</i>日程：</th>
							<td><textarea class="common-text" name="content"
									id="content" style="width: 430px; height: 80px;">${schedule.content}</textarea></td>
