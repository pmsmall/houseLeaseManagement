...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="/houseLeaseManagement/js/button_style.js"></script>
		<style>
			.error {
				font-size: 13px;
				color: red;
					...
					<table class="insert-tab" style="width: 100%;">
						<tbody>
							...
							<tr>
								...
								<td><input class="common-text required" value="${userlist.name}" id="name" name="name" size="50" type="text"></td>
							</tr>
							<tr>
							...
							<tr class="light">
								<th></th>
								<td><input name="submit" id="commit_button" class="btn btn-primary btn6 mr10" value="提交" type="submit"> <input name="reset" id="rollback_button" class="btn btn6" onclick="history.go(-1)" value="返回" type="button"></td>
							</tr>
							<tr>
								<td>
