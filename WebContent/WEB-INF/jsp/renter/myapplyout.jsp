...
<html>
	...
	<body>
		<div>
			...
			<form id="houseForm" name="houseForm" action="/applyout/getmyapplyout.action" method=post>
				<div class="result-title">
									...
									<tr class="result_tab_body">
										...
										<td>
											<c:if test="${ applyout.status!='申请中'}">
												<a class="link-update" href="/houseLeaseManagement/applyout/deleteapplyout.action?id=${applyout.id}" onclick="return window.confirm('确定要删除该记录吗？')">删除</a>
												&nbsp;&nbsp;
											</c:if>
										</td>
									</tr>
